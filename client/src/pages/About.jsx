    ...
    <div className="relative min-h-screen bg-obsidian text-porcelain overflow-hidden">
      ...
      <div className="relative max-w-2xl mx-auto px-8 py-24">
        ...
        <h1 className="font-editorial text-5xl mb-10 leading-tight">
          Built to help you prepare.
        </h1>

        <div className="space-y-6 font-ui text-porcelain/80 leading-relaxed">
          <p>
            Interview Analyzer brings together three things that usually live in separate,
            disconnected tools: resume-to-job matching, mock interview practice, and
            voice-based delivery feedback — in one practical, end-to-end experience.
          </p>
          <p>
            Most interview preparation advice is generic — the same twenty tips repeated across
            a hundred articles, regardless of who you are or what role you're applying for.
            Interview Analyzer does the opposite. Every match score is computed against the actual
